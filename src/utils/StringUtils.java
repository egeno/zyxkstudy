...
public class StringUtils {
	...
	public static Integer StringDateToAge(Timestamp date) throws Exception{
		...
		int x = calb.get(Calendar.YEAR);
		int age = x-y;
		return age;
	}
	
	public static Integer idNumberToAge(String idNumber) throws Exception{
		...
		Timestamp date = Timestamp.valueOf(strYear + "-" + strMonth + "-" + strDay + " " + "00:00:00");		
		return StringDateToAge(date);
	}
...
//	}
	 ...
	 * @throws Exception
	 */
	public static String StringDatePlusN(String date,int n) throws Exception{
		DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Date dd = df.parse(date);
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(dd);
